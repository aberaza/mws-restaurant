  ...
  fetchRestaurantFromURL((error, restaurant) => {
    if (error) {
      ...
      L.tileLayer(
        ...
        {
          mapboxToken:
            "pk.eyJ1IjoiYWJlcjE3MzAiLCJhIjoiY2ptczNpM3ZuMDZqMTNrbzg2ZWxtNHBqeSJ9.abr4ugbLzqbNldKbQWAnUg",
          maxZoom: 18,
          attribution:
...
createReviewHTML = review => {
  ...
  rating.role="img";
  rating["aria-label"]=`${review.rating} out of 5`;
  let stars = "";
  for (let i = 0; i < 5; i++) {
    if (i < review.rating) {
      stars += "&starf;";
...
fillBreadcrumb = (restaurant = self.restaurant) => {
  ...
  li["aria-current"]="restauranti info page";
